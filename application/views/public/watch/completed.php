<div class="anime">
	<div class="anime-body">
				<div class="heading heading-default"><h4>SEASON COMPLETED</h4></div>
		...
		<?php 
					 	...
					 	if(is_object($next)){
					 	 ...
					 	 <?php if (!empty($episode_number)): ?>
					 	 	<div class="item-4 item-2-s item-1-xs  cover-contents">
						...
						//}
					 ?></div>
					<a href="<?=site_url('watch/c/'.$key->slug)?>" class="cover-photo" data-cover="<?=$key->thumbnail?>"><!--img src="<?=$key->thumbnail?>"--></a>
...
<?php endif ?>
	...
	<div class="anime-sidebar">
			...
			<?php if (!empty($list_mostviews) && is_array($list_mostviews)): ?>
				...
				<a class="item-2 item-2-s item-1-xs  cover-contents" href="<?=base_url('watch/v/'.$key->slug)?>" data-slug="<?=$key->slug?>">
