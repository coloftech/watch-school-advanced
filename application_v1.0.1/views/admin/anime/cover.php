	...
	<div class="panel-body">
		...
		<div class="col-md-8">
			...
			<div class="form-group">
				...
				<input type="text" name="release_time" id="release_time" placeholder="12:00:00" class="form-control" style="width:100px;display:inline-block;" value="<?=isset($cover_page->released_date) ? date('H:i:s',strtotime($cover_page->released_date)) : "12:00:00";?>"> 
			</div>
