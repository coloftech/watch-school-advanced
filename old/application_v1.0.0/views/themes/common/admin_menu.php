<nav class="navbar navbar-default-primary navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?=site_url('watchschool_anime_admin_home');?>">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li><a href="<?=site_url('watchschool_anime_admin_home');?>"><i class="fa fa-fw fa-home"></i>Dashboard</a></li>
                ...
                <li>
                    ...
                    <ul id="menu-videos" class="collapse">
                        ...
                        <li><a href="<?=site_url('video');?>"><i class="fa fa-angle-double-right"></i> Add/Update</a></li>
                ...
                <li><a href="#"  data-toggle="collapse" data-target="#backup-1"><i class="fa fa-fw fa-home"></i>Backup <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                 <ul id="backup-1" class="collapse">
                        ...
                        <li><a href="<?=site_url('watchschool_anime_admin_home/backupvideos');?>"><i class="fa fa-angle-double-right"></i> Video only</a></li>
                        <li><a href="<?=site_url('watchschool_anime_admin_home/create_zip');?>"><i class="fa fa-angle-double-right"></i> Full database</a></li>
