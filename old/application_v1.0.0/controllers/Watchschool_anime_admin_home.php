...
* 
*/
class Watchschool_anime_admin_home extends CI_Controller
{
	...
	public function index($value='')
	{
		...
		$this->themes->run('admin','admin/index',$data);
	}
	...
	public function backupvideos($value='')
	{
		# code...
		$prefs = array(
        'tables'        => array('q_videos', 'q_video_episode','q_video_mirror','q_video_cover','q_video_reports'),   // Array of tables to backup.
