...
class Video extends CI_Controller
{
	...
	public function index($value='')
	{
		...
		$this->themes->run('admin','admin/anime/new',$data);
	}
	...
	public function change_link($value='')
	{
		...
		if($this->input->post()){
			...
			$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.mp4upload.com/embed-'.$link_id.'.html"></iframe></div>';
			...
			$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.youtube.com/embed/'.$link_id.'?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
			...
			$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.facebook.com/plugins/video.php?href='.$link_id.'&mute=0"  data-controls="false" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe></div>';
			...
			$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.dailymotion.com/embed/video/'.$link_id.'" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
			...
			$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://openload.co/embed/'.$link_id.'" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe></div>';
			...
			if($obj->video_link == 6){
				...
				if($obj->txtlink != $link_id){
					...
					$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://drive.google.com/file/d/'.$link_id.'/preview?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';

				}else{
					$link_id =  str_replace('view?usp=sharing', '', $obj->txtlink);

					$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="'.$link_id.'/preview" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
			...
			if($obj->video_link == 7){
			    ...
			    $embed = '<div class="embed-responsive embed-responsive-16by9"><video width="320" height="240"  class="embed-responsive-item" controls>
                  <source src="'.$link_id.'" type="video/mp4">
			...
			if($obj->video_link == 8){
				$link_id = str_replace('https://vimeo.com/', '', $obj->txtlink);
					...
					$embed = '<iframe src="https://player.vimeo.com/video/'.$link_id.'"  class="embed-responsive-item"   frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
			...
			if($obj->video_link == 9){
				...
				$link_id = $obj->txtlink;
					...
					$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="'.$link_id.'" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';

				
				
			}
			if ($obj->video_link == 10) {
				# code...
				$embed ='
				<div class="embed-responsive embed-responsive-16by9"><iframe  class="embed-responsive-item" src="'.$obj->txtlink.'"></iframe></div>
				';
			}
	...
	function change_title(){
		...
		$obj = (object)$this->input->post();
	        $title = array('title'=>$obj->title);
				if($isupdated = $this->video_m->update_video($obj->video_id,$title)){
					echo json_encode(array('stats'=>true,'msg'=>$title));
				}else{
					echo json_encode(array('stats'=>false));
				}
	    }else{
	...
	function change_synopsis(){
	    if($this->input->post()){
	        
		$obj = (object)$this->input->post();
	        $synopsis = array('sypnosis'=>$obj->synopsis);
				if($isupdated = $this->video_m->update_video($obj->video_id,$synopsis)){
					echo json_encode(array('stats'=>true,'msg'=>$synopsis));
				}else{
					echo json_encode(array('stats'=>false));
				}
	    }else{
	...
	public function episodes($video_id=false)
	{
		...
		$this->themes->run('admin','admin/anime/episodes',$data);
	...
	public function add($video_id='')
	{
		...
		$this->themes->run('admin','admin/anime/add',$data);
	}
		...
		if(!empty($obj->txtlink)){
			...
			if($obj->videosource == 6){
				...
				if($obj->txtlink != $link_id){
					...
					$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="'.$link_id.'/preview?autoplay=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
			...
			$input = array(
				...
				'slug'=>$this->slug->create($obj->txtepisodetitle.' no '.$obj->txtepisodenumber.' m '.$obj->videosource),
				'tags'=>$obj->txttags,
				'embed'=>$embed,
				'link'=>$obj->txtlink,
				'thumbnail'=>$thumbnail,	
			...
			if($is_added = $this->video_m->save($input)){
				...
				//$addlatest = $this->video_m->addlatestVideo($obj->video_id);
		...
		if(!empty($obj->txtlink)){
			...
			if($obj->videosource == 9){
				$link_id =  $obj->txtlink;
					...
					$embed = '<div class="embed-responsive embed-responsive-16by9"><video class="embed-responsive-item" controls><source src="'.$link_id.'">Your browser does not support the video tag.</video></div>';
			...
			$input = array(
				'title'=>$obj->txttitle,
				'slug'=>$this->slug->create($obj->txttitle.' no '.$obj->episodenumber.' m '.$obj->videosource),
				'tags'=>$obj->txttags,
				'embed'=>$embed,
				'link'=>$obj->txtlink,
				'source_id'=>$obj->videosource,
	...
	public function save_source($value='')
	{
		...
		if(!empty($obj->txtlink)){
			...
			$embed = '<div class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="https://www.facebook.com/plugins/video.php?href='.$link_id.'&mute=0" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe></div>';
