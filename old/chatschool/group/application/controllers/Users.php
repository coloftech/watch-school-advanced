...
class Users extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['users'] = $contacts;
		$this->load->view('chatschool/chat-form', $data);	
	}
	public function group($value='')
	{
		...
		$this->load->view('chatschool/group-form');
	}
	...
	public function editProfile(){
		...
		if(!empty($_POST)){
			...
			$this->load->view('chatschool/edit_profile', $data);	
		}				
	}
	public function changePassword(){
		...
		if(!empty($_POST)){
			...
			$this->load->view('chatschool/change_password');	
		}
	...
	public function toggle_status(){
		...
		$toggled = $this->user->update($id, array('online'=>$status));	
